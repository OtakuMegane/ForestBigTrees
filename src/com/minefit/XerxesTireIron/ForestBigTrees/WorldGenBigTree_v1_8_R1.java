...
import net.minecraft.server.v1_8_R1.BlockLogAbstract;
import net.minecraft.server.v1_8_R1.BlockPosition;
import net.minecraft.server.v1_8_R1.Blocks;
import net.minecraft.server.v1_8_R1.EnumLogRotation;
import net.minecraft.server.v1_8_R1.Material;
import net.minecraft.server.v1_8_R1.MathHelper;
import net.minecraft.server.v1_8_R1.World;
import net.minecraft.server.v1_8_R1.WorldGenTreeAbstract;

public class WorldGenBigTree_v1_8_R1 extends WorldGenTreeAbstract {
    ...
    public WorldGenBigTree_v1_8_R1(boolean flag, boolean treeFix) {
        super(flag);
        bigTreeFix = treeFix;
    ...
    void b() {
        ...
        while (iterator.hasNext()) {
            ...
            this.a(worldgenbigtreeinnerclassposition);
        }
    ...
    void d() {
        ...
        while (iterator.hasNext()) {
            ...
            if (this.c(i - this.m.getY())) {
                this.a(blockposition, worldgenbigtreeinnerclassposition, Blocks.LOG);
            }
        }
