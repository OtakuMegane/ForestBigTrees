...
public class WorldGenBigTree_v1_8_R3 extends WorldGenTreeAbstract {
    ...
    int h;
    int i;
    List<WorldGenBigTree_v1_8_R3.Position> j;
    boolean bigTreeFix;

    public WorldGenBigTree_v1_8_R3(boolean flag, boolean treeFix) {
        super(flag);
        bigTreeFix = treeFix;
    ...
    void a() {
        ...
        this.j.add(new WorldGenBigTree_v1_8_R3.Position(this.m.up(k), j));
                ...
                for (int l = 0; l < i; ++l) {
                    ...
                    if (this.a(blockposition, blockposition1) == -1) {
                        ...
                        if (this.a(blockposition2, blockposition) == -1) {
                            this.j.add(new WorldGenBigTree_v1_8_R3.Position(blockposition, blockposition2.getY()));
                        }
                    }
                }
            }
    ...
    void b() {
        ...
        while (iterator.hasNext()) {
            WorldGenBigTree_v1_8_R3.Position worldgenbigtree_position = (WorldGenBigTree_v1_8_R3.Position) iterator.next();
