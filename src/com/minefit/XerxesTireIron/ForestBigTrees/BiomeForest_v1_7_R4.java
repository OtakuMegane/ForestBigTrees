...
public class BiomeForest_v1_7_R4 extends BiomeForest
{
    private int aF;
    private WorldGenBigTree_v1_7_R4 bigTree;
    private ForestBigTrees plugin;
    private CraftWorld world;
    private int bigTreeRandom;

    public BiomeForest_v1_7_R4(int i, int j, ForestBigTrees instance, CraftWorld world)
    {
        super(i, j);
        plugin = instance;
        this.world = world;
        bigTree = new WorldGenBigTree_v1_7_R4(false, plugin.getConfig().getBoolean("worlds." + world.getName() + ".big-tree-fix", false));
    ...
    protected BiomeBase k()
    {
        ...
        {
            BiomeForest_v1_7_R4 biomeforest = new BiomeForest_v1_7_R4(id + 128, 1, plugin, world);
