...
public class BiomeForest_v1_7_R3 extends BiomeForest
{
    ...
    public BiomeForest_v1_7_R3(int i, int j, ForestBigTrees instance, CraftWorld world)
    {
        super(i, j);
        plugin = instance;
        this.world = world;
        bigTree = new WorldGenBigTree_v1_7_R3(false, plugin.getConfig().getBoolean("worlds." + world.getName() + ".big-tree-fix", false));
    ...
    protected BiomeBase k()
    {
        ...
        {
            BiomeForest_v1_7_R3 biomeforest = new BiomeForest_v1_7_R3(id + 128, 1, plugin, world);
